      ...
      <Slide direction='right' triggerOnce duration={1500}>
        <div className='grid grid-cols-12 shadow-lg'>
          <div className='row-span-full col-start-2 md:col-start-1 col-end-13 md:col-end-8 col-span-7 flex flex-col justify-center gap-2 py-2 z-10'>
            ...
            <h2 className='text-2xl md:text-4xl text-white font-bold '>2. Mock Project 2</h2>
            <p className='md:text-lg rounded-md text-primary  md:bg-dark py-2 px-1'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Exercitationem eum odit impedit autem quo quisquam quidem dolorum, temporibus enim similique nemo sapiente ratione nesciunt maiores vero. Sed natus nihil facere!</p>
