...
const Work = () => {
  ...
  return (
    <div name='work' className='w-full bg-[#1f2731]'>
      ...
      <h1 className='text-4xl font-semibold py-5  '>Projects</h1>
      ...
      <div className='grid grid-cols-12'>
          <div className='row-span-full col-start-2 md:col-start-6 col-end-12 md:col-end-13 col-span-7 flex flex-col justify-center gap-2 py-2 z-10'>
            ...
            <h2 className='text-2xl md:text-4xl font-bold md:text-end'>Pro-Lab</h2>
            <p className='md:text-lg rounded-md   md:bg-gray-400 py-2 px-1'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Exercitationem eum odit impedit autem quo quisquam quidem dolorum, temporibus enim similique nemo sapiente ratione nesciunt maiores vero. Sed natus nihil facere!</p>
            <ul className='flex md:justify-end gap-2 mb-5'>
        ...
        <div className='grid grid-cols-12'>
          <div className='row-span-full col-start-2 md:col-start-1 col-end-13 md:col-end-8 col-span-7 flex flex-col justify-center gap-2 py-2 z-10'>
            ...
            <h2 className='text-2xl md:text-4xl font-bold '>Pro-Lab</h2>
            <p className='md:text-lg rounded-md  md:bg-gray-400 py-2 px-1'>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Exercitationem eum odit impedit autem quo quisquam quidem dolorum, temporibus enim similique nemo sapiente ratione nesciunt maiores vero. Sed natus nihil facere!</p>
